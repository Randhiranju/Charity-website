...
<div style="margin-left: 60px;" class="col-md-11 content">
  ...
  <form class="form-horizontal reg-form" action="charityCheck.php" method="post" enctype="multipart/form-data" id="uploadForm">
    <div class="form-group form-group-md">
      ...
      <div class="col-md-6">
        <input class="form-control" type="text" required placeholder="Name of the fund raiser" value=<?php echo $_SESSION['user'] ?> readonly name="founder">
      </div>
    </div>
    ...
    <div class="form-group form-group-md">
      ...
      <div class="col-sm-6">
        <input class="form-control" type="text" required placeholder="Charity Name" maxlength="50" name="c_name">
      </div>
    </div>
    <div class="form-group form-group-md">
      <label class="col-md-2 control-label">Purpose of charity</label>
      <div class="col-md-6">
        <input class="form-control" type="text" required placeholder="Ex:trees,poor,etc..," maxlength="200" name="c_purpose">
      </div>
    </div>
    <div class="container">
